    ...
    def step(self):
        ...
        for agent in self.agents:
            if isinstance(agent, (MarketingAgent)):
                marketing = agent
            elif isinstance(agent, (OperationsAgent)):
                operations = agent
        # ============================================
        ...
        # ============================================
        # 3. PHYSICAL FLOW (Production & Shipping)
        # ============================================
        ...
        # ============================================
        # 5. REWARD CALCULATION (Echelon Holding Costs per Cachon & Zipkin 1999)
        # ============================================
